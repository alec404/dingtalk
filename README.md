...
- 执行dingtalk_test.go测试方法可直接查看以下消息内容。
...
### 获取
-   ```go
    go get github.com/alec404/dingtalk
    ```
### 初始化
-   ```go
    ...
    ```
-   ```go
    import "github.com/alec404/dingtalk"
...
2. 配置POST地址，外网是可访问的接口地址，如：`http://robot.alec404.com/outgoing` 。
...
## Acknowledgments
This project is based on [dingtalk](https://github.com/blinkbean/dingtalk), originally created by [blinkbean].